...
| Bridge | File | Connects |
|---|---|---|
| **Forge ↔ SDLC ↔ PDLC** | [`sdlc/methodologies/forge/FORGE-SDLC-PDLC-BRIDGE.md`](sdlc/methodologies/forge/FORGE-SDLC-PDLC-BRIDGE.md) | Forge delivery methodology ↔ SDLC phases A–F ↔ PDLC phases P1–P6: Ore pipeline to PDLC discovery, Assay Gate to launch readiness, Bellows to discipline challenges |

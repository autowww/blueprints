...
flowchart TB
  ...
  MO --> EV
  EV --> DE
  DE -.->|monitoring & new questions| BU
  EV -.->|revisit features or data| DP
  EV -.->|try other algorithms| MO
  DU -.->|clarify goals or scope| BU
```
...
flowchart LR
  subgraph CRISP["CRISP-DM"]
    BU2[Business Understanding]
    DU2[Data Understanding]
    DP2[Data Preparation]
    MO2[Modeling]
    EV2[Evaluation]
    DE2[Deployment]
  end
  subgraph SDLC["SDLC (illustrative)"]
    A[A / B]
    C[C / D]
    D2[D]
    E[E]

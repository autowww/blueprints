...
```mermaid
graph TB
  subgraph core ["Core knowledge areas"]
    direction TB
  ...
  SA -->|"defines change strategy"| EC
  EC -->|"confirmed information"| RLCM
  EC -->|"confirmed information"| RADD
  RLCM -->|"approved requirements"| RADD
  RADD -->|"design options"| SE
  SE -.->|"assessment results"| SA
```
...
| **Communication skills** | Written and verbal clarity, active listening, presentation | Ceremony facilitation in [`ceremonies/`](../../../sdlc/methodologies/ceremonies/) |

...
| [**BA-SDLC-PDLC-BRIDGE.md**](BA-SDLC-PDLC-BRIDGE.md) | How BA maps across PDLC P1–P6 and SDLC A–F — role mapping, technique selection, anti-patterns |
...
| [`blueprints/pdlc/`](../../../pdlc/README.md) | BA Strategy Analysis maps to PDLC P1–P3; Solution Evaluation maps to P5–P6. BA provides the **techniques** (interviews, workshops, modeling) that PDLC phases rely on for evidence generation. See [**BA-SDLC-PDLC-BRIDGE.md**](BA-SDLC-PDLC-BRIDGE.md). |

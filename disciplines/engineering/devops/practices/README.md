...
DevOps practices are the **how** of continuous delivery: they turn culture and goals from [`DEVOPS.md`](../DEVOPS.md) into repeatable workflows — automated pipelines, codified infrastructure, observable systems, and resilient response — so teams ship small batches safely and learn from production.
...
**Quick links:** [CI/CD](ci-cd.md) · [IaC & GitOps](iac-gitops.md) · [SRE / observability](sre-observability.md) · [Incidents](incident-management.md) · [DevOps body of knowledge](../DEVOPS.md)

...
| [`blueprints/pdlc/`](../../../pdlc/README.md) | PDLC P2 (Validate) includes feasibility assessment — architecture provides the technical feasibility lens. P3 (Plan & Commit) defines NFRs and constraints that architecture must satisfy. P5 (Grow) generates tech debt and scalability demands that architecture must address. |

...
| **CCPA / CPRA** | — | California consumer privacy — notice, opt-out, sensitive data, service provider rules | California consumers; US businesses meeting statutory thresholds |
| **EU AI Act** | *(planned)* | AI system and model obligations — risk classes, transparency, conformity | AI features; high-risk annex domains; general-purpose model providers |
| **SOC 2** | *(planned)* | Trust Service Criteria — security + optional categories; Type I / II | B2B SaaS; customer diligence |
| **ISO 27001** | *(planned)* | ISMS — Annex A controls; certification | Contractual requirement; global enterprise sales |
| **SOX** | *(planned)* | Financial reporting — ITGC, audit trails, SoD | Systems impacting financial statements (US public issuers) |
| **COPPA** | *(planned)* | US children’s online privacy — parental consent, limits | Services directed to children or with actual knowledge of under-13 users |

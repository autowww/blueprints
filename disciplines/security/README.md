...
| [`blueprints/pdlc/`](../../pdlc/README.md) | PDLC P3 (Strategize) scopes compliance requirements. P4 (Launch) includes security readiness review. P5 (Grow) involves incident response and ongoing vulnerability management. |

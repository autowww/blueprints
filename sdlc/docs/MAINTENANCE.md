...
| [`../methodologies/spec-driven-development.md`](../methodologies/spec-driven-development.md) | [`spec-driven.html`](spec-driven.html) |
| [`../methodologies/spec-driven/*.md`](../methodologies/spec-driven/README.md) | [`spec-driven-sdd-schema.html`](spec-driven-sdd-schema.html) · [`spec-driven-sdd-ceremonies.html`](spec-driven-sdd-ceremonies.html) · [`spec-driven-sdd-process.html`](spec-driven-sdd-process.html) |
| [`../templates/sdd/*.md`](../templates/sdd/README.md) | (templates — copy to consuming repos; no generated HTML) |
| [`../../agents/STRUCTURE.md`](../../agents/STRUCTURE.md) (when present) | [`agents.html`](agents.html) |
| [`../../ide/STRUCTURE.md`](../../ide/STRUCTURE.md), [`../../ide/README.md`](../../ide/README.md) (when present) | [`ide.html`](ide.html) |
...
| [`../methodologies/*.md`](../methodologies/README.md) | [`methodologies.html`](methodologies.html) (hub) · [`methodologies-roles.html`](methodologies-roles.html) · [`methodologies-ceremonies.html`](methodologies-ceremonies.html) · methodology hubs · **subchapters** `methodologies-{scrum,kanban,phased,xp}-{foundation,ceremonies,process}.html` — run [`build_methodology_chapters.py`](build_methodology_chapters.py) from `docs/` after changing shared layout or regenerating tables/diagrams; **[`methodologies-scrum-roles.html`](methodologies-scrum-roles.html) is hand-edited** (not overwritten by the builder). Legacy stub script [`_generate_methodology_subpages.py`](_generate_methodology_subpages.py) skips those paths. · [`methodologies-agile.html`](methodologies-agile.html) · [`methodologies-agentic.html`](methodologies-agentic.html) — **canonical depth** in Markdown (incl. [`../methodologies/ceremonies/`](../methodologies/ceremonies/README.md), [`../methodologies/scrum/`](../methodologies/scrum/README.md), `kanban/`, `phased/`, `xp/`) |
| **—** | **Left nav:** [`assets/docs-nav.js`](assets/docs-nav.js) builds the chapter list from **`DOC_NAV`**: each item is a **leaf** `{ href, label }` or a **group** `{ hubHref, label, groupId, children: [...] }`. **Methodologies** may include **nested hubs** inside `children`: `{ hubHref, label, groupId, children: [ leaves ] }` (e.g. Scrum → Foundation, Roles, …) for a visible tree. Add more top-level groups when you add `phases-*.html` (or similar). Keep empty [`#doc-sidebar-nav`](index.html) / [`#doc-offcanvas-nav`](index.html) placeholders in each HTML shell. |

**Chapter files** (same layout shell; **update [`assets/docs-nav.js`](assets/docs-nav.js)** when adding/renaming a nav entry): [`index.html`](index.html) (landing), [`overview.html`](overview.html), [`phases.html`](phases.html), [`dod.html`](dod.html), [`change.html`](change.html), [`review.html`](review.html), [`cicd.html`](cicd.html), [`documentation.html`](documentation.html), [`spec-driven.html`](spec-driven.html), [`spec-driven-sdd-schema.html`](spec-driven-sdd-schema.html), [`spec-driven-sdd-ceremonies.html`](spec-driven-sdd-ceremonies.html), [`spec-driven-sdd-process.html`](spec-driven-sdd-process.html), [`agents.html`](agents.html), [`ide.html`](ide.html), [`methodologies.html`](methodologies.html), [`methodologies-roles.html`](methodologies-roles.html), [`methodologies-ceremonies.html`](methodologies-ceremonies.html), [`methodologies-scrum.html`](methodologies-scrum.html) + subchapters (Foundation/Ceremonies/Process from [`build_methodology_chapters.py`](build_methodology_chapters.py); **Roles** hand-maintained), same for **kanban**, **phased**, **xp**, [`methodologies-agile.html`](methodologies-agile.html), [`methodologies-agentic.html`](methodologies-agentic.html), [`governance.html`](governance.html).
...
| [`assets/docs-toc-scrollspy.js`](assets/docs-toc-scrollspy.js) | On pages with `nav.doc-toc` (**Documentation layout**, **Spec-driven development**, **Agents & automation**, **Change control**, **Roles & archetypes**, **Ceremonies**), highlights the **On this page** link for the section in view. |

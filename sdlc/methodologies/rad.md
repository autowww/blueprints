...
![RAD — four phases](../docs/assets/methodology-rad-phases.svg)
...
|----------|------------------------------------------|
| [**Wikipedia — Rapid application development**](https://en.wikipedia.org/wiki/Rapid_application_development) | **Stable overview** of RAD — phases, tools, comparison with traditional approaches. |
...
- [Wikipedia — Rapid application development](https://en.wikipedia.org/wiki/Rapid_application_development) — **Overview**.
- Companion: [Agile umbrella](agile.md), [Spiral](spiral.md) (also prototyping-oriented), [Shape Up](shape-up.md)

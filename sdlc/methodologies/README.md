...
| Guide | Topics |
|-------|--------|
| [**Agile (umbrella)**](agile.md) | Values, principles, how Scrum/Kanban/XP combine; choosing a primary rhythm. |
| [**Scrum**](scrum.md) | Roles, events, artifacts, sprint flow; agentic fit; tracking. **Prescriptive package:** [`scrum/README.md`](scrum/README.md). |
...
| [**Feature-Driven Development (FDD)**](fdd.md) | Model-driven, feature-centric; five activities; chief programmers and class ownership; designed for larger teams. |
| [**Crystal**](crystal.md) | Family of methods scaled by team size and criticality; seven properties shared across variants (Clear, Yellow, Orange, Red). |
| [**DSDM**](dsdm.md) | Agile governance framework; MoSCoW prioritization; fixed time/cost, variable scope; integrates with PRINCE2. |
| [**Shape Up**](shape-up.md) | Basecamp's methodology: 6-week cycles, appetites, shaping, betting table, hill charts; full team autonomy during build. |
...
| [**V-Model**](v-model.md) | Verification and validation pairing; each development level maps to a test level; traceability-driven. **Prescriptive package:** [`v-model/README.md`](v-model/README.md). |
| [**Spiral Model**](spiral.md) | Risk-driven iterative development; four quadrants per cycle; anchor-point milestones (LCO, LCA, IOC). **Prescriptive package:** [`spiral/README.md`](spiral/README.md). |
| [**RAD (Rapid Application Development)**](rad.md) | Prototyping-centric; rapid iterations, user involvement, timeboxing; historical precursor to modern Agile. |
...
| Guide | Topics |
|-------|--------|
| [**SAFe (Scaled Agile Framework)**](safe.md) | Multi-team coordination, PI Planning, ART, portfolio governance; scaling Lean-Agile. **Prescriptive package:** [`safe/README.md`](safe/README.md). |
| [**Disciplined Agile (DA)**](disciplined-agile.md) | PMI's process-decision toolkit: goal-driven approach with multiple lifecycle options (Agile, Lean, CD, Exploratory, Program). |
...
| Guide | Topics |
|-------|--------|
| [**Lean Software Development**](lean.md) | Seven principles (eliminate waste, amplify learning, decide late, deliver fast, empower, build integrity, optimize the whole); value-stream thinking; Kaizen. **Prescriptive package:** [`lean/README.md`](lean/README.md). |
| [**DevOps**](devops.md) | Culture + practices + toolchain unifying Dev and Ops; CI/CD, IaC, monitoring, DORA metrics, incident response. **Prescriptive package:** [`devops/README.md`](devops/README.md). |
...
| Guide | Topics |
|-------|--------|
| [**Spec-driven development**](spec-driven-development.md) | Written intent leads implementation; docs↔code loop; agentic fit. **SDD I/O:** [`spec-driven/README.md`](spec-driven/README.md), templates [`templates/sdd/`](../templates/sdd/). Handbook: [`spec-driven.html`](../docs/spec-driven.html). |
| [**BDD (Behavior-Driven Development)**](bdd.md) | Given-When-Then scenarios as living specifications and automated acceptance tests; complements TDD and spec-driven development. |
...
| Guide | Topics |
|-------|--------|
| [**Forge SDLC**](forge.md) | AI-native delivery methodology: Ore→Ingot→Spark→Charge pipeline; Bellows (discipline challenge agents covering 16 disciplines); Ember Log (decision memory); Assay Gate (evidence-based release); hat-switching for solo-to-enterprise scaling. **Prescriptive package:** [`forge/README.md`](forge/README.md). |

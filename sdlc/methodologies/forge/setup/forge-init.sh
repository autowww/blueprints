...
if [[ -d "$CURSOR_DIR" ]]; then
  echo "  .cursor/rules/ exists — copy Bellows and daily rules manually from:"
  echo "    blueprints/sdlc/methodologies/forge/bellows/*.mdc.template"
...
echo "  2. Copy Bellows templates to .cursor/rules/ (remove .template suffix)"

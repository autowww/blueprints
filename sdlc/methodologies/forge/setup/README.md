...
4. **Validate** — `bash blueprints/sdlc/methodologies/forge/setup/sync-forge-cursor-rules.sh check`; after blueprint updates, `sync-forge-cursor-rules.sh diff --preset recommended` then `sync … --force` if appropriate.

...
| **Estimation (method)** | **Fibonacci** / **t-shirt** / **token bands**, roll-up Spark → Ingot → Product Spark, **defect multipliers** — owned by **Estimation** Versona (`versona-estimation`); **`docs/requirements/ESTIMATES.md`** + **`forge/estimation/ESTIMATION-RULES.md`**. **PM** consumes sizes for commitments; does not own the method. | [`versona/catalog/discipline/governance/versona-estimation.mdc.template`](versona/catalog/discipline/governance/versona-estimation.mdc.template) · [`../../templates/forge/estimation/ESTIMATION-RULES.template.md`](../../templates/forge/estimation/ESTIMATION-RULES.template.md) · [`planning/README.md`](planning/README.md) |
...
| **Forge Agent** | Bounded governable agent session under a **ForgeRun**; recorded as **AgentRun** (`arun_*`) with a workcell id. Forge is not an agent. | Forge Platform handbook: [Forge Agent](https://platform.forgesdlc.com/docs/forge-agent.html) · `forge-platform/docs/forge-agent.md` |
| **Forge Campaign** | Multi-repo branch-aware automation under one **ForgeRun**, manifest-driven; distinct from marketing “campaign” and from **Charge** (not a branch). | Forge Platform handbook: [Forge Campaign](https://platform.forgesdlc.com/docs/forge-campaign.html) · `forge-platform/docs/forge-campaign.md` · branching: [`setup/BRANCHING-STRATEGY.md`](setup/BRANCHING-STRATEGY.md) § Forge Campaign automation |

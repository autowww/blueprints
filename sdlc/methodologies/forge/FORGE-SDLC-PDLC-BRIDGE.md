...
| **P2 Validate solution** | Bellows challenge validates feasibility; PoC planning | PDLC ↔ Forge |
...
| **P5 Grow** | Learning from released work feeds new Ore; metrics feed Bellows | Forge ↔ PDLC |
...
|--------|---------------------------------|--------------------------|
| Releases frequently have quality issues | Strengthen Assay Gate evidence; add Bellows | — |
...
| Stakeholder surprises at review | Strengthen Refinement and Bellows challenge | — |
| Solo developer with stable product | — | Minimal ceremonies; AI Bellows; self-Assay |
...
| Bellows only check engineering concerns | Product and governance blind spots | Activate Product and Governance family Bellows |
...
3. **Bellows challenge:** Architecture Bellows flags scalability concern; Security Bellows flags token storage risk. Both captured in Ember Log.
...
| [`../../../disciplines/README.md`](../../../disciplines/README.md) | Discipline hub (Bellows knowledge bases) |
| [`bellows/README.md`](bellows/README.md) | Bellows challenge agents |

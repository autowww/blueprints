...
**Executive summary + diagram:** [`../lean.md`](../lean.md) · Poppendieck's *Lean Software Development* (book).
...
**Related:** [Ceremony fork](../ceremonies/lean.md) · [Methodology bridge](../ceremonies/methodology-bridge.md) · [Kanban](../kanban.md) (operationalizes Lean flow)

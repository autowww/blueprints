...
| **Versonas** | Discipline virtual personas; activities include structured challenge (contract-specified) and other discipline work | [Versonas overview](forge/versona/README.md) · [Methodology orchestration](forge/orchestration/README.md) (`versona-forge-sdlc`) · [Standards precedence & profiles](forge/standards/README.md) · [Operating model (optional machine artifacts)](forge/VERSONA-OPERATING-MODEL.md) · [Versona flow (sessions)](forge/process-and-flows.md#8-versona-flow-sessions-and-discipline-work) · [Template catalog](forge/versona/README.md#template-catalog) |

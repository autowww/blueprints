...
| **Versonas** | Discipline virtual personas; activities include structured challenge (contract-specified) and other discipline work | [Versonas overview](forge/versona/README.md) · [Challenge flow](forge/process-and-flows.md#8-versona-challenge-flow) · [Template catalog](forge/versona/README.md#template-catalog) |

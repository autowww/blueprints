...
1. Keep this folder at **repository root** as **`blueprints/docs/`** (or copy the subtree).  
2. Add **`docs/product/`** (mutable) and seed it from **`templates/`** — never put project prose inside **`blueprints/docs/`**.  
3. From **`docs/INDEX.md`** (or root `README.md`), link to **`blueprints/docs/README.md`** and **`docs/product/`**.  
4. Optional: add **`docs/PROJECT.md`** for stack and planning pointers; keep **`blueprints/docs/`** free of those details.

# Blueprints repository — `docs/`

Mutable **maintainer and product** documentation for this repo. (Frozen methodology packages remain under `sdlc/`, `pdlc/`, `disciplines/`, etc., per [`sdlc/POLICY.md`](../sdlc/POLICY.md).)

| Document | Purpose |
|----------|---------|
| [`../sdlc/quickstarts/README.md`](../sdlc/quickstarts/README.md) | **First hour** — hands-on path in a consuming repo (not ICP selection) |

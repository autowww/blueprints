...
| **Waterfall discovery** | P1→P2→P3 run as a single, sequential "requirements phase" taking months before any SDLC work begins. | 6-month "discovery phase" followed by 6-month "build phase." Late feedback. Assumptions stale by launch. | Adopt Dual-Track Agile: run discovery and delivery in parallel. Keep P1–P2 cycles short (1–2 weeks per experiment). See [`approaches/dual-track-agile.md`](approaches/dual-track-agile.md). |
